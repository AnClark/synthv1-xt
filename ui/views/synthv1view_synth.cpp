...
// Color palettes.
static constexpr const auto SYNTH2_COLOR = IM_COL32(113, 166, 85, 255);
static constexpr const auto SYNTH2_COLOR_HOVERED = IM_COL32(162, 231, 143, 255);
static constexpr const auto SYNTH2_COLOR_ACTIVE = IM_COL32(116, 165, 102, 255);
...
void SynthV1PluginUI::_uiView_Synth(bool isSynth1)
{
    ...
    if (ImGui::BeginChild(d_cconst('D', 'C', 'O', '1'), ImVec2(1300, 100 + ImGui::CalcTextSize("test").y * 2), true, window_flags)) [[likely]]
    {
...

        {
            ...
            VeeOneWidgets::OscWave("DCO Wave 1", &fOscWave1, &m_shape1, &fParamStorage[isSynth1 ? synthv1::DCO1_WIDTH1 : synthv1::DCO2_WIDTH1], 60, 60);
            ImGui::SameLine(0, 10);

            _addWaveSelector("DCO Wave 1", isSynth1 ? synthv1::DCO1_SHAPE1 : synthv1::DCO2_SHAPE1); ImGui::SameLine(0, 20);
            _addKnob("Width 1", isSynth1 ? synthv1::DCO1_WIDTH1 : synthv1::DCO2_WIDTH1); ImGui::SameLine(0, 20);

            ImGui::BeginGroup();
            _addCheckbox("Bandl.1", isSynth1 ? synthv1::DCO1_BANDL1 : synthv1::DCO2_BANDL1);
            _addCheckbox("Sync 1", isSynth1 ? synthv1::DCO1_SYNC1 : synthv1::DCO2_SYNC1);
            ImGui::EndGroup();
        }
...

        {
            ...
            VeeOneWidgets::OscWave("DCO Wave 2", &fOscWave2, &m_shape2, &fParamStorage[isSynth1 ? synthv1::DCO1_WIDTH2 : synthv1::DCO2_WIDTH2], 60, 60);
            ImGui::SameLine(0, 10);

            _addWaveSelector("DCO Wave 2", isSynth1 ? synthv1::DCO1_SHAPE2 : synthv1::DCO2_SHAPE2); ImGui::SameLine(0, 20);
            _addKnob("Width 2", isSynth1 ? synthv1::DCO1_WIDTH2 : synthv1::DCO2_WIDTH2); ImGui::SameLine(0, 20); 

            ImGui::BeginGroup();
            _addCheckbox("Bandl.2", isSynth1 ? synthv1::DCO1_BANDL2 : synthv1::DCO2_BANDL2);
            _addCheckbox("Sync 2", isSynth1 ? synthv1::DCO1_SYNC2 : synthv1::DCO2_SYNC2);
            ImGui::EndGroup();
        }
    ...
    if (ImGui::BeginChild(d_cconst('L', 'F', 'O', '1'), ImVec2(720, 220), true, window_flags)) [[likely]]
    {
...

        {
            ...
            VeeOneWidgets::OscWave("LFO Wave 1", &fLfoWave, &m_shape, &fParamStorage[isSynth1 ? synthv1::LFO1_WIDTH : synthv1::LFO2_WIDTH], 60, 60);
            ImGui::SameLine(0, 10);
    ...
    if (ImGui::BeginChild(d_cconst('D', 'E', 'F', '1'), ImVec2(440, 100 + ImGui::CalcTextSize("test").y * 2), true, window_flags)) [[likely]]
    {
        ...
        // Add a left padder to make sure the "Pitchbend" label can be fully shown
        ImGui::Dummy(ImVec2(5, 0)); ImGui::SameLine();

        _addKnob("Pitchbend##DEF", isSynth1 ? synthv1::DEF1_PITCHBEND : synthv1::DEF2_PITCHBEND); ImGui::SameLine(0, 20);
